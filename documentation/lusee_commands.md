...
| 0x57 | RFS_SET_PRODMASK_LOW  | set the output correlation mask products 0-7 (autocorrelations are 4 LSB) 
| 0x58 | RFS_SET_PRODMASK_HIGH | set the output correlation mask products 8-15
